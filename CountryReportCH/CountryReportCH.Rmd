...
### Mettre le texte utilisé dans le FlexDashboard
...
BalanceTransactionsCGraph <- ggplot(BalanceTransactionsC, aes(x = period, y = value, color = country)) +
  ...
  labs(y = "Balance transaction", title = "Balance on current transactions with the rest of the world", caption = "Source: SKEMA Quantum Studio")

BalanceTransactionsCGraph <- ggplotly(BalanceTransactionsCGraph) %>%
  layout(legend = list(orientation = "h", x = 0.4, y = -0.2))
BalanceTransactionsCGraph
```
...
ggplot(CPIc, aes(x = period, y = value, color = Country)) +
  ...
  theme(legend.position="bottom") + 
   guides(col = guide_legend(nrow = 4)) +
  labs(y = "Consumer Price Index", title = "CPI comparison", caption = "Source: SKEMA Quantum Studio")
```
...
ForeignPopulationPlot <- ggplot(ForeignPopulation, aes(x = period, y = value, color = Country)) +
  ...
  theme(legend.position="bottom") + 
   guides(col = guide_legend(nrow = 4)) +
  labs(y = "Foreign population in % of total pop", title = "Stock of foreign population by nationality", caption = "Source: SKEMA Quantum Studio")
```
...
CrimesComparisonPlot <- ggplot(CrimesComparison, aes(x = period, y = value, color = Country)) +
  ...
  labs(y = "Intentional homicide per 
       hundred thousand inhabitants", title = "Crimes stats", caption = "Source: SKEMA Quantum Studio")
```
...
ggplot(PovertyComparison, aes(x = period, y = value, color = Country)) +
  ...
  theme(legend.position="bottom") + 
   guides(col = guide_legend(nrow = 4)) +
  labs(y = "% at risk of poverty", title = "People at risk of poverty or social exclusion by age and sex
", caption = "Source: SKEMA Quantum Studio")
```
...
ggplot(CorruptionIndex2019) +
 ...
 scale_color_hue() +
 labs(y = "Value", title = "Corruption Perceptions Index") +
 ggthemes::theme_stata()
```

### Description à ajouter au graphique précédent
